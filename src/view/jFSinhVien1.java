...
//            String tenLop = pmc.layTenTheoMaLop(sv.getMaLop());
    ...
    private void initComponents() {
        ...
        pnl11Layout.setHorizontalGroup(
            ...
            .addGroup(pnl11Layout.createSequentialGroup()
                .addGroup(pnl11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnl11Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(lblDanhSachPM, javax.swing.GroupLayout.PREFERRED_SIZE, 855, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        cboSach.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tất cả", "Số lượng thấp đến cao", "Số lượng cao đến thấp" }));
    ...
    private void cboSachActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboSachActionPerformed
        ...
        else if(cboSach.getSelectedIndex() == 1){
